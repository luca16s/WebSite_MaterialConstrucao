...
<div class="sidebar1">
  ...
  <div class="content">
   <div id='cssmenu'>
    ...
    <form name="frmproduto" action="cadproduto.php" method="post" id="frmcadastro" enctype="multipart/form-data">
        ...
        <label>Quantidade: </label><input type="text" name="quantidade" /> <label>Forncedor:</label> <input type="text" name="fornecedor" /><br /> <label>Preço:</label> <input type="text" name="preco" /><br />
        ...
        <center><table><tr><td><input type="submit" name="enviar" value="Enviar" class="botaoForm2" />
        </form></center></td><td>
        <center><form action="indexadm.php" name="frmexcluirproduto" method="post" >
