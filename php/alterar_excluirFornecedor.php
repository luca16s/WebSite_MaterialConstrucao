...
<div class="sidebar1">
  ...
  <div class="content">
   <div id='cssmenu'>
    ...
    <p align="center"><b>	ALTERAR/EXCLUIR PRODUTO</b> </p>
		<center><form name="frmpesquisar" action="pesquisarproduto.php" method="post" id="frmcadastro">
        ...
        <form action="indexadm.php" name="frmcancelar" method="post" >
        	<input type="submit" name="cancelar" value="Cancelar" class="botaoForm2"/> </form></td></tr></center></div></table>
    </div>
