...
<div class="container">
  ...
  <div class="content">
    ...
    <p align="center"><b>	EXCLUIR PRODUTO</b> </p>
<form name="confirmacaoExclusao" action="excluirProduto.php" method="post" id="frmcadastro" enctype="multipart/form-data">
		...
		<input type='hidden' name='fake2' value='". $fake2 ."'>
