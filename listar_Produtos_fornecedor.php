...
<div class="sidebar1">
  ...
  <div class="content">
   <div id='cssmenu'>
    ...
    <p align="center"><b>	PESQUISAR PRODUTOS POR FORNECEDOR</b> </p>
    <center><form name="frmpesquisar" action="pesquisar_Produto_fornecedor.php" method="post" id="frmcadastro">
    	<label>CNPJ: </label> <input type="text" name="cnpj"><br />
        <table align="center"><tr><td><input type="submit" name="enviar" value="Enviar" class="botaoForm2" /> </form></td><td>

        <form action="indexadm.php" name="frmcancelar" method="post" >
        	<input type="submit" name="cancelar" value="Cancelar" class="botaoForm2"/> </form></td></tr></table></center></div>
